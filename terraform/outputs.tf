output "database_url" {
  ...
  value       = "postgres://${var.db_username}:${data.aws_secretsmanager_secret_version.password.secret_string}@${aws_db_instance.main.address}:5432/${var.db_name}?sslmode=require"
  sensitive   = true
}
